...
if User.objects.filter(email=seller_email).exists():
    print(f"Usuario {seller_email} ya existe")
    ...
    print(f"✓ Usuario vendedor creado: {seller_email}")
...
if hasattr(seller, 'seller_profile'):
    ...
    print(f"✓ Perfil de vendedor actualizado")
...
if User.objects.filter(email=buyer_email).exists():
    print(f"Usuario {buyer_email} ya existe")
else:
    ...
    print(f"✓ Usuario comprador creado: {buyer_email}")

print("\n=== Usuarios de prueba ===")
print(f"Vendedor: {seller_email} / {seller_password}")
print(f"Comprador: {buyer_email} / {buyer_password}")
